package com.example.datasources.generator;
...
public class MyBatisPlusGenerator {
    ...
    //作者名
    private static final String AUTHOR = "wh";
    //表table的前缀，不加到生成的类名中
    private static final String PREFIX = "t_";
    //要生成的表名
    private static final String[] TABLES= {"想生成代码的表名"};
    private static final String JDBC_URL = "jdbc:mysql://localhost:3306/dt-commercialization?useUnicode=true&characterEncoding=UTF-8" +
            "&useSSL=false&zeroDateTimeBehavior=convertToNull&";
    private static final String JDBC_DRIVER = "com.mysql.jdbc.Driver";
    private static final String JDBC_USERNAME = "root";
    private static final String JDBC_PASSWORD = "123456";
    private static final String BASE_PACKAGE = "com.haier.dtcommercialization";
    ...
    private static void cofnigCustom(AutoGenerator generator, String projectPath) {
        ...
        focList.add(new FileOutConfig(templatePath) {
            ...
            public String outputFile(TableInfo tableInfo) {
                ...
                return projectPath.concat("/src/main/java/").concat(BASE_PACKAGE).concat("/")
